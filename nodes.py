    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "magcache_thresh": ("FLOAT", {"default": 0.12, "min": 0.0, "max": 0.3, "step": 0.01, "tooltip": "How strongly to cache the output of diffusion model. This value must be non-negative."}),
